...
import static org.dillon.fx.event.ThemeEvent.EventType.COLOR_CHANGE;
import static org.dillon.fx.event.ThemeEvent.EventType.FONT_CHANGE;
...
public final class ThemeManager {
    ...
    public void setFontFamily(String fontFamily) {
        ...
        reloadCustomCSS();
        EVENT_BUS.publish(new ThemeEvent(FONT_CHANGE));
    }
    ...
    public void resetAccentColor() {
        ...
        EVENT_BUS.publish(new ThemeEvent(COLOR_CHANGE));
    }
